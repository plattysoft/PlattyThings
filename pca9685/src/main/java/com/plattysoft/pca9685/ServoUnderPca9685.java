...
public class ServoUnderPca9685 implements AutoCloseable {
    private static final String TAG = ServoUnderPca9685.class.getSimpleName();
     ...
     * @throws IOException
     */
    public ServoUnderPca9685(Pwm device) throws IOException {
        try {
            connect(device, DEFAULT_FREQUENCY_HZ);
